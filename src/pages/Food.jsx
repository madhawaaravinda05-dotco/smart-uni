      ...
      {selected && (
        <>
          ...
          <div style={{ position: "fixed", inset: 0, zIndex: 101, overflowY: "auto", padding: "40px 24px" }}
            ...
            {/* The Modal */}
            <div style={{ margin: "0 auto", background: theme.cardBg, borderRadius: 24, maxWidth: 480, width: "100%", overflow: "hidden", boxShadow: "0 24px 64px rgba(0,0,0,.25)", border: `1px solid ${theme.cardBorder}`, position: "relative" }}
